...
<div class="text-center mb-4">
    ...
    <p class="mb-0">Driver Login</p>
</div>
<div class="form-body">
    <form class="row g-3" action="{{route('drivers.handleLogin')}}" method="POST">
        @csrf
        <div class="col-12">
    ...
    <div  class="mt-3">
    <span>New Driver ? <a href="{{route('drivers.register')}}">New Driver</a></span>
    </div>
</div>
@endsection