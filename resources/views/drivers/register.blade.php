...
<div class="text-center mb-4">
    ...
    <p class="mb-0">Driver Register</p>
</div>
<div class="form-body">
    <form class="row g-3" action="{{ route('drivers.handleRegister') }}" method="POST">
        @csrf
        <div class="col-12">
    ...
    <div  class="mt-3">
        <span>Existing Driver ? <a href="{{route('drivers.login')}}">Login</a></span>
    </div>
</div>
@endsection
